package net.blueva.arcade.modules.bed_wars.support.store;
...
public class BedWarsStoreService {

    private final ModuleConfigAPI moduleConfig;
    private final StoreAPI storeAPI;
    private final ModuleInfo moduleInfo;

    public BedWarsStoreService(ModuleConfigAPI moduleConfig, StoreAPI storeAPI, ModuleInfo moduleInfo) {
    ...
    public void registerStoreItems() {
        if (storeAPI == null || !moduleConfig.getBoolean("cages.enabled", true)) {
            return;
        }
    ...
    private void registerCategoryFromStore(String key) {
        ...
        Material randomIcon = parseMaterial(moduleConfig.getStringFrom("store.yml", base + ".random_item.icon"), Material.ENDER_CHEST);
