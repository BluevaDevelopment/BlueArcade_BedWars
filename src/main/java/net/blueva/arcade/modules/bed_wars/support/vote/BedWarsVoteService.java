...
public class BedWarsVoteService {
    ...
    public BedWarsVoteService(ModuleConfigAPI moduleConfig,
        ...
        this.menuRepository = new BedWarsVoteMenuRepository(moduleConfig);
    ...
    private void registerMenusWithCore() {
        if (menuAPI != null) {
            BedWarsMenuAPI bedWarsMenuAPI = new BedWarsMenuAPI(menuAPI, this);
            menuAPI.registerModuleMenuAPI(moduleId, bedWarsMenuAPI);
            menuAPI.registerModuleMenuAPI("bed", bedWarsMenuAPI);
        }
    }
    ...
    public void setGame(BedWarsGame game) {
        this.game = game;
    }
    ...
    private String resolvePlayerVoteLabel(Player player, VoteState voteState, VoteCategory category) {
        ...
        return getOptionLabel(category, vote);
    }
