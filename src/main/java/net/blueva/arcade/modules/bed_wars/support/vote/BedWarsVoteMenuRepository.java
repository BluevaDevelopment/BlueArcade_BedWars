...
public class BedWarsVoteMenuRepository {

    private final ModuleConfigAPI moduleConfig;
    private final Map<String, MenuDefinition<Material>> menus = new HashMap<>();

    public BedWarsVoteMenuRepository(ModuleConfigAPI moduleConfig) {
        this.moduleConfig = moduleConfig;
    }

    public void loadMenus() {
        menus.clear();
        loadMenu(BedWarsVoteService.MENU_MAIN, "menus/java/bed_wars_vote_main.yml",
                "menus/bedrock/bed_wars_vote_main.yml");
        loadMenu(BedWarsVoteService.MENU_HEARTS, "menus/java/bed_wars_vote_hearts.yml",
                "menus/bedrock/bed_wars_vote_hearts.yml");
        loadMenu(BedWarsVoteService.MENU_TIME, "menus/java/bed_wars_vote_time.yml",
                "menus/bedrock/bed_wars_vote_time.yml");
        loadMenu(BedWarsVoteService.MENU_WEATHER, "menus/java/bed_wars_vote_weather.yml",
                "menus/bedrock/bed_wars_vote_weather.yml");
    }
    ...
    private void loadMenu(String id, String javaFile, String bedrockFile) {
        ...
        String title = javaConfig.getString("menu_name", "");
        int size = javaConfig.getInt("menu_size", 9);
    ...
    private List<JavaMenuItem<Material>> loadJavaItems(ConfigurationSection section) {
        ...
        for (String key : section.getKeys(false)) {
            ...
            ConfigurationSection stackSection = itemSection.getConfigurationSection("item_stack");
    ...
    private BedrockMenuDefinition loadBedrockMenu(String bedrockFile) {
        ...
        String title = bedrockConfig.getString("menu_name", "");
