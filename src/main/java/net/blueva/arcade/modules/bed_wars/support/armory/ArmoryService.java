...
public class ArmoryService {
    ...
    public ArmoryService(ModuleConfigAPI moduleConfig) {
    ...
    public void openChestClone(Player player,
        ...
        String configuredTitle = moduleConfig.getString("inventories.chest_clone_title", "<dark_gray>Chest</dark_gray>");
